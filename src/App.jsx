          ...
          <div className="bg-white text-slate-900 p-12 rounded-[3rem] mb-20 flex flex-col md:flex-row justify-between items-center gap-12">
            <div className="max-w-md">
              ...
              <div className="flex gap-4">
                <a href="https://wa.me/0852703000579" target="_blank" rel="noreferrer" className="bg-green-600 text-white px-6 py-4 rounded-xl font-bold">WhatsApp 085270300579</a>
